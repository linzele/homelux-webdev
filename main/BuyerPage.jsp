...
<head>
    ...
    <link rel="stylesheet" href="assets/css/BuyerHome.css">
...
<header class="header">
    <div class="container">
        ...
        <nav class="navbar">
            ...
            <a href="MyListingsController" class="navbar-link">Saved Listings</a>
            <a href="MortgagePage.html" class="navbar-link">Mortgage Calculator</a>
            <a href="#about" class="navbar-link">Review REA</a>
            <a href="#about" class="navbar-link">Rate REA</a>
    ...
    <section class="hero">
        <div class="container-body">
            ...
            <div class="image-container">
                <img src="assets/images/buyer.jpg" alt="Modern house model" class="w-100">
            </div>
        </div>
    </section>
</main>
