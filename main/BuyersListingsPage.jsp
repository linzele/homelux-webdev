...
<head>
    ...
    function toggleSaveListing(postalCode, unitNumber, button) {
        ...
        xhttp.onload = function() {
            ...
            // Optionally, you might want to remove the card if unsaved
            if (response === "unsaved") {
...
<body>
    <div class="container">
        ...
        <c:forEach items="${savedListings}" var="property">
            <div class="property-card">
                ...
                <button class="action-button-save" onclick="toggleSaveListing('${property.postalCode}', '${property.unitNumber}', this)">
