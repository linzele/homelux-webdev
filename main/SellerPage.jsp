...
<head>
    ...
    <link rel="stylesheet" href="assets/css/SellerHome.css">
...
<header class="header">
    <div class="container">
        ...
        <nav class="navbar">
            ...
            <a href="MyListingsController" class="navbar-link">My Listings</a>
    ...
    <section class="hero">
        <div class="container-body">
            ...
            <div class="image-container">
                <img src="assets/images/seller.jpg" alt="Modern house model" class="w-100">
            </div>
        </div>
    </section>
</main>
